...
class SmsApiTest extends ApiTest {
    ...
    void shouldSendFullyFeaturedSmsMessage() {
        ...
        int givenGroupId = 1;
        SmsMessageGeneralStatus givenGroupName = SmsMessageGeneralStatus.PENDING;
        ...
        SmsValidityPeriodTimeUnit givenValidityPeriodTimeUnit = SmsValidityPeriodTimeUnit.HOURS;
        ...
        SmsMessage firstMessage = new SmsMessage()
                ...
                .content(new SmsTextMessageContent()
                        .text(givenText)
    ...
    void shouldGetDeliveryReports() {
        ...
        SmsMessageGeneralStatus givenGroupName = SmsMessageGeneralStatus.DELIVERED;
        Integer givenId = 5;
        ...
        Consumer<SmsDeliveryReports> assertions = (response) -> {
            then(response).isNotNull();
    ...
    private void thenStatusIsPending(SmsMessageStatus status) {
        ...
        then(status.getGroupName()).isEqualTo(SmsMessageGeneralStatus.PENDING);
    ...
    private void thenStatusIsDelivered(SmsMessageStatus status) {
        ...
        then(status.getGroupName()).isEqualTo(SmsMessageGeneralStatus.DELIVERED);
    ...
    void shouldSendSMSDeliveryReports() {
        ...
        SmsMessageGeneralStatus givenStatusGroupNameMessage1 = SmsMessageGeneralStatus.DELIVERED;
        ...
        SmsMessageGeneralStatus givenStatusGroupNameMessage2 = SmsMessageGeneralStatus.DELIVERED;
        ...
        Consumer<SmsDeliveryReports> assertions = (deliveryResult) -> {
