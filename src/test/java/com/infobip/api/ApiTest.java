...
abstract class ApiTest {
    ...
    protected void setUpSuccessPostRequest(
            String url, Map<String, String> expectedParameters, String expectedRequest, String givenResponse) {
    ...
    protected void setUpEmptyPostRequest(
            String url, Map<String, String> expectedParameters, String givenResponse, int statusCode) {
        wireMockServer.givenThat(post(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Content-Type", equalTo(EXPECTED_CONTENT_TYPE_HEADER_VALUE))
                .withHeader("Accept", equalTo(EXPECTED_ACCEPT_HEADER_VALUE))
    ...
    protected void setUpPostRequest(
            String url,
    ...
    protected void setUpNoResponseBodyPostRequest(
            String url, Map<String, String> expectedParameters, String expectedRequest, int statusCode) {
        wireMockServer.givenThat(post(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Content-Type", equalTo(EXPECTED_CONTENT_TYPE_HEADER_VALUE))
                .withHeader("Accept", equalTo(EXPECTED_ACCEPT_HEADER_VALUE))
    ...
    protected void setUpNoRequestBodyDeleteRequest(
            String url, Map<String, String> expectedParameters, String givenResponse, int statusCode) {
    ...
    protected void setUpNoResponseBodyDeleteRequest(
            String url, Map<String, String> expectedParameters, String expectedRequest, int statusCode) {
        wireMockServer.givenThat(delete(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Content-Type", equalTo(EXPECTED_CONTENT_TYPE_HEADER_VALUE))
    ...
    protected void setUpNoResponseBodyDeleteRequest(
            String url, Map<String, String> expectedParameters, int statusCode) {
        wireMockServer.givenThat(delete(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("User-Agent", matching("infobip-api-client-java/.*"))
                .withQueryParams(equalToParams(expectedParameters))
    ...
    protected void setUpMultipartRequest(
            String url, List<Multipart> expectedParts, String givenResponse, int statusCode) {
        MappingBuilder mappingBuilder = post(urlPathEqualTo(url));
        expectedParts.forEach(part -> mappingBuilder.withMultipartRequestBody(
                aMultipart(part.getName()).withBody(equalTo(part.getBody()))));
        mappingBuilder
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
    ...
    protected void setUpGetRequestOctet(
            String url, Map<String, String> expectedParameters, String givenResponse, int statusCode) {
    ...
    protected void setUpGetRequest(
            String url, Map<String, String> expectedParameters, String givenResponse, int statusCode) {
        wireMockServer.givenThat(get(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Accept", equalTo(EXPECTED_ACCEPT_HEADER_VALUE))
    ...
    protected void setUpNoResponseBodyPutRequest(
            String url, Map<String, String> expectedParameters, String expectedRequest, int statusCode) {
        wireMockServer.givenThat(put(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Content-Type", equalTo(EXPECTED_CONTENT_TYPE_HEADER_VALUE))
    ...
    protected void setUpPatchRequest(
            String url,
            Map<String, String> expectedParameters,
            String expectedRequest,
            String givenResponse,
    ...
    protected void setUpNoResponseBodyPatchRequest(
            String url, Map<String, String> expectedParameters, String expectedRequest, int statusCode) {
        wireMockServer.givenThat(patch(urlPathEqualTo(url))
                .withHeader("Authorization", equalTo(EXPECTED_API_KEY_HEADER_VALUE))
                .withHeader("Content-Type", equalTo(EXPECTED_CONTENT_TYPE_HEADER_VALUE))
