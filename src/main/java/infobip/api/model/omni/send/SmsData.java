...
import infobip.api.model.omni.send.Language;
...
public class SmsData {
    ...
    public SmsData setTransliteration(String transliteration) {
    ...
    public SmsData setText(String text) {
        this.text = text;
        return this;
    }
    ...
    public SmsData setValidityPeriod(Long validityPeriod) {
    ...
    public SmsData setValidityPeriodTimeUnit(TimeUnit validityPeriodTimeUnit) {
