...
import com.infobip.auth.ApiKeyAuth;
import com.infobip.auth.Authentication;
import com.infobip.auth.HttpBasicAuth;
import com.infobip.auth.OAuth;
import com.infobip.auth.OAuthFlow;
import com.infobip.auth.RetryingOAuth;
import java.io.File;
...
public class ApiClient {
  ...
  public ApiClient() {
    ...
    authentications.put("IBSSOTokenHeader", new ApiKeyAuth("header", "Authorization"));
  ...
  public ApiClient(
    ...
    String tokenUrl = "/auth/1/oauth2/token";
  ...
  private void init() {
    ...
    setUserAgent("infobip-api-client-java/3.2.0");
