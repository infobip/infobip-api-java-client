...
/**
 * Template header. Should be defined, only if placeholders or media have been registered in the
 * template&#39;s header.
 */
public abstract class WhatsAppTemplateHeaderContent {
  ...
  public WhatsAppTemplateHeaderContent type(String type) {
  ...
  public String toString() {
    ...
    sb.append("class WhatsAppTemplateHeaderContent {\n");
