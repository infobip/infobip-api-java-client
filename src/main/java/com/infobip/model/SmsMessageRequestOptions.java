...
public class SmsMessageRequestOptions {
    ...
    private SmsUrlOptions tracking;
     ...
     * @return This {@link SmsMessageRequestOptions instance}.
     */
    public SmsMessageRequestOptions tracking(SmsUrlOptions tracking) {
    ...
    public SmsUrlOptions getTracking() {
        return tracking;
    }
     ...
     */
    @JsonProperty("tracking")
    public void setTracking(SmsUrlOptions tracking) {
        this.tracking = tracking;
    }
