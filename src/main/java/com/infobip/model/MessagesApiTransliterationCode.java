...
public enum MessagesApiTransliterationCode {
    ...
    MessagesApiTransliterationCode(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static MessagesApiTransliterationCode fromValue(String value) {
        for (MessagesApiTransliterationCode enumElement : MessagesApiTransliterationCode.values()) {
