 ...
 */
public class ResourcesDeliveryTimeWindow {
    ...
    private ResourcesDeliveryTimeZone deliveryTimeZone;
     ...
     *
     * @param from
     * @return This {@link ResourcesDeliveryTimeWindow instance}.
     */
    public ResourcesDeliveryTimeWindow from(String from) {
        this.from = from;
        return this;
    }
     ...
     * @return This {@link ResourcesDeliveryTimeWindow instance}.
     */
    public ResourcesDeliveryTimeWindow to(String to) {
        this.to = to;
        return this;
    }
     ...
     * @return This {@link ResourcesDeliveryTimeWindow instance}.
     */
    public ResourcesDeliveryTimeWindow days(Set<ResourcesDayOfWeek> days) {
        this.days = days;
        return this;
    }
     ...
     * @return This {@link ResourcesDeliveryTimeWindow instance}.
     */
    public ResourcesDeliveryTimeWindow addDaysItem(ResourcesDayOfWeek daysItem) {
        if (this.days == null) {
     ...
     * @return This {@link ResourcesDeliveryTimeWindow instance}.
     */
    public ResourcesDeliveryTimeWindow deliveryTimeZone(ResourcesDeliveryTimeZone deliveryTimeZone) {
    ...
    public ResourcesDeliveryTimeZone getDeliveryTimeZone() {
        return deliveryTimeZone;
    }
     ...
     */
    @JsonProperty("deliveryTimeZone")
    public void setDeliveryTimeZone(ResourcesDeliveryTimeZone deliveryTimeZone) {
        this.deliveryTimeZone = deliveryTimeZone;
    }
    ...
    public boolean equals(Object o) {
        ...
        ResourcesDeliveryTimeWindow resourcesDeliveryTimeWindow = (ResourcesDeliveryTimeWindow) o;
        return Objects.equals(this.from, resourcesDeliveryTimeWindow.from)
                && Objects.equals(this.to, resourcesDeliveryTimeWindow.to)
                && Objects.equals(this.days, resourcesDeliveryTimeWindow.days)
                && Objects.equals(this.deliveryTimeZone, resourcesDeliveryTimeWindow.deliveryTimeZone);
    }
    ...
    public String toString() {
        ...
        return new StringBuilder()
                .append("class ResourcesDeliveryTimeWindow {")
                .append(newLine)
                .append("    from: ")
