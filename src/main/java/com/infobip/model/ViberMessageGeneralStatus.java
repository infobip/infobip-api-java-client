...
public enum ViberMessageGeneralStatus {
    ...
    ViberMessageGeneralStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ViberMessageGeneralStatus fromValue(String value) {
        for (ViberMessageGeneralStatus enumElement : ViberMessageGeneralStatus.values()) {
