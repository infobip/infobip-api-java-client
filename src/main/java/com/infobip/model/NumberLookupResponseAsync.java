...
public class NumberLookupResponseAsync {
    ...
    private List<NumberLookupResponseAsyncDetails> results = null;
     ...
     */
    public NumberLookupResponseAsync results(List<NumberLookupResponseAsyncDetails> results) {
    ...
    public List<NumberLookupResponseAsyncDetails> getResults() {
        return results;
    }
     ...
     */
    @JsonProperty("results")
    public void setResults(List<NumberLookupResponseAsyncDetails> results) {
        this.results = results;
    }
