 ...
 */
public enum MessagesApiMessageGeneralStatus {
    ACCEPTED("ACCEPTED"),
    PENDING("PENDING"),
    ...
    MessagesApiMessageGeneralStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static MessagesApiMessageGeneralStatus fromValue(String value) {
        for (MessagesApiMessageGeneralStatus enumElement : MessagesApiMessageGeneralStatus.values()) {
