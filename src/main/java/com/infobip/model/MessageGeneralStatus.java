...
public enum MessageGeneralStatus {
    ...
    MessageGeneralStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static MessageGeneralStatus fromValue(String value) {
        for (MessageGeneralStatus enumElement : MessageGeneralStatus.values()) {
