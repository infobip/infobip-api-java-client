 ...
 */
public enum WhatsAppMessageGeneralStatus {
    ACCEPTED("ACCEPTED"),
    PENDING("PENDING"),
    ...
    WhatsAppMessageGeneralStatus(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static WhatsAppMessageGeneralStatus fromValue(String value) {
        for (WhatsAppMessageGeneralStatus enumElement : WhatsAppMessageGeneralStatus.values()) {
