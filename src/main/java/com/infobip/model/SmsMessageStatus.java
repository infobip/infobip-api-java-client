...
public class SmsMessageStatus {
    ...
    private MessageGeneralStatus groupName;
     ...
     * @return This {@link SmsMessageStatus instance}.
     */
    public SmsMessageStatus groupName(MessageGeneralStatus groupName) {
    ...
    public MessageGeneralStatus getGroupName() {
        return groupName;
    }
     ...
     */
    @JsonProperty("groupName")
    public void setGroupName(MessageGeneralStatus groupName) {
        this.groupName = groupName;
    }
