...
public class SmsValidityPeriod {
    ...
    private SmsValidityPeriodTimeUnit timeUnit;
     ...
     * @return This {@link SmsValidityPeriod instance}.
     */
    public SmsValidityPeriod timeUnit(SmsValidityPeriodTimeUnit timeUnit) {
    ...
    public SmsValidityPeriodTimeUnit getTimeUnit() {
        return timeUnit;
    }
     ...
     */
    @JsonProperty("timeUnit")
    public void setTimeUnit(SmsValidityPeriodTimeUnit timeUnit) {
        this.timeUnit = timeUnit;
    }
