...
public class ViberOutboundImageContent extends ViberOutboundContent {
     ...
     */
    public ViberOutboundImageContent values(Map<String, Object> values) {
        this.values = values;
        return this;
    }
     ...
     * @return This {@link ViberOutboundImageContent instance}.
     */
    public ViberOutboundImageContent putValuesItem(String key, Object valuesItem) {
        if (this.values == null) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.values, viberOutboundImageContent.values)
                && Objects.equals(this.text, viberOutboundImageContent.text)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(values, text, mediaUrl, button, super.hashCode());
    }
