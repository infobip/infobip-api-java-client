...
/**
 * Represents MmsLogsResponse model.
 */
public class MmsLogsResponse {
     ...
     */
    public MmsLogsResponse results(List<MmsLog> results) {
     ...
     * @return This {@link MmsLogsResponse instance}.
     */
    public MmsLogsResponse addResultsItem(MmsLog resultsItem) {
     ...
     */
    @JsonProperty("results")
    public void setResults(List<MmsLog> results) {
        this.results = results;
    }
     ...
     * @return This {@link MmsLogsResponse instance}.
     */
    public MmsLogsResponse cursor(CursorPageInfo cursor) {
        this.cursor = cursor;
        return this;
    }
