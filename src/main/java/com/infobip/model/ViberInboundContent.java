...
@JsonTypeInfo(
        ...
        visible = true)
@JsonSubTypes({
    @JsonSubTypes.Type(value = ViberInboundFileContent.class, name = "FILE"),
...
public abstract class ViberInboundContent {
    ...
    public boolean equals(Object o) {
        ...
        ViberInboundContent viberInboundContent = (ViberInboundContent) o;
        return Objects.equals(this.type, viberInboundContent.type);
    }
    ...
    public String toString() {
        ...
        return new StringBuilder()
                .append("class ViberInboundContent {")
                .append(newLine)
                .append("    type: ")
