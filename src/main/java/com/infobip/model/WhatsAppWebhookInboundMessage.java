...
public abstract class WhatsAppWebhookInboundMessage {
    ...
    private WhatsAppWebhookContext context;
     ...
     */
    public WhatsAppWebhookInboundMessage context(WhatsAppWebhookContext context) {
    ...
    public WhatsAppWebhookContext getContext() {
        return context;
    }
     ...
     */
    @JsonProperty("context")
    public void setContext(WhatsAppWebhookContext context) {
        this.context = context;
    }
