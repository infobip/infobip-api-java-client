...
/**
 * Represents MessagesApiOutboundTypingStoppedEvent model.
 */
public class MessagesApiOutboundTypingStoppedEvent extends MessagesApiOutboundEvent {
    ...
    /**
     * Constructs a new {@link MessagesApiOutboundTypingStoppedEvent} instance.
     */
    public MessagesApiOutboundTypingStoppedEvent() {
     ...
     */
    public MessagesApiOutboundTypingStoppedEvent channel(OutboundEventChannel channel) {
     ...
     * @return This {@link MessagesApiOutboundTypingStoppedEvent instance}.
     */
    public MessagesApiOutboundTypingStoppedEvent sender(String sender) {
        this.sender = sender;
        return this;
    }
     ...
     * @return This {@link MessagesApiOutboundTypingStoppedEvent instance}.
     */
    public MessagesApiOutboundTypingStoppedEvent destinations(List<MessagesApiToDestination> destinations) {
     ...
     * @return This {@link MessagesApiOutboundTypingStoppedEvent instance}.
     */
    public MessagesApiOutboundTypingStoppedEvent addDestinationsItem(MessagesApiToDestination destinationsItem) {
     ...
     * @return This {@link MessagesApiOutboundTypingStoppedEvent instance}.
     */
    public MessagesApiOutboundTypingStoppedEvent options(MessagesApiEventOptions options) {
    ...
    public boolean equals(Object o) {
        ...
        MessagesApiOutboundTypingStoppedEvent messagesApiOutboundTypingStoppedEvent =
                (MessagesApiOutboundTypingStoppedEvent) o;
        return Objects.equals(this.channel, messagesApiOutboundTypingStoppedEvent.channel)
                && Objects.equals(this.sender, messagesApiOutboundTypingStoppedEvent.sender)
                && Objects.equals(this.destinations, messagesApiOutboundTypingStoppedEvent.destinations)
                && Objects.equals(this.options, messagesApiOutboundTypingStoppedEvent.options)
                && super.equals(o);
    }
    ...
    public String toString() {
        ...
        return new StringBuilder()
                .append("class MessagesApiOutboundTypingStoppedEvent {")
                .append(newLine)
                .append("    ")
